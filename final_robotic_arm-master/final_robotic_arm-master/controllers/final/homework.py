...
def fwd_kin(q):
    ...
    for i in range(6):
        rot_z = _________________     # rotation about z axis by q[i]. You created it above.
        dh    = _____________________ # dh-transformation     for dh_param[i]. You created it above.
        M = M @ rot_z @ dh
...
def control(get_joint_angles, set_joint_angles,
    ...
    for c in [RED, GREEN, BLUE]:
        while True:
            ...
            #
            gx = _____________________________
            gy = _____________________________
